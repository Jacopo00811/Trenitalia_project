...
# Accessing the column 'Descrizione' of the file_source
descriptions = file_source['Descrizione'].tolist()

filtered_descriptions = []

# Filtering the words in the descriptions together with apostrophes and short form of words
...
# Updating the column 'Descrizione' of the file_source
...
# Finding the matching codes for each description
...
# Ordering from most apperances to least amd removing duplicates from the column 'Codici Documenti' of the file_source
    array = []
